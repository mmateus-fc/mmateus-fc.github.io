...
function initializeScrollAnimations() {
    ...
    const animateElements = document.querySelectorAll('.timeline-item, .project-card, .skill-icon');
...
function preloadImages() {
    const images = [
        'assets/images/mfc_logo_transparent_1-removebg.png',
        'assets/images/tech_icons_set.png',
        'assets/images/social_media_icons.png'
    ];
